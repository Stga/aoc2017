...
public class Puzzle08Main {
	public static void main(String[] args) {
		try {
			...
			while( (command=br.readLine()) != null) {
				...
				final boolean eval = Puzzle08Main.executeConditional(comparisonRegVal, operator, comparisonVal);
	...
	private static boolean executeConditional(int registerVal, String operator, int comparisonVal) {
		switch(operator) {
